...
class RAGWorkflow:
    ...
    def __init__(self, model: str = None, embedding_model: str = None):
        ...
        Args:
            model: Model/deployment name for answer generation
        ...
        if azure_endpoint:
            ...
            self.model = model or os.environ.get("AZURE_OPENAI_CHAT_DEPLOYMENT", "gpt-4o-deployment")
            # For embeddings, use separate deployment or default
